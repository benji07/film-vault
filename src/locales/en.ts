export const en = {
	...
	stock: {
		...
		hierarchy: {
			...
			brand: "Brand",
			model: "Model",
			childCount_one: "{{count}} category",
			childCount_other: "{{count}} categories",
			modelCount_one: "{{count}} model",
			modelCount_other: "{{count}} models",
			filmCount_one: "{{count}} film",
			filmCount_other: "{{count}} films",
		},
		emptyActive: "No active film",
		emptyActiveSubtitle: "Load a film to get started",
		emptyStock: "Empty stock",
		emptyStockSubtitle: "Add films to your inventory",
		emptyArchive: "No archive",
		emptyArchiveSubtitle: "Your scanned films will appear here",
	...
	account: {
		...
		sendError: "Couldn't send the code. Check the address and your connection.",
		sendErrorRateLimit: "Too many requests. Try again in {{seconds}} seconds.",
		sendErrorRateLimitGeneric: "Too many requests. Wait a moment before trying again.",
		sendErrorInvalidEmail: "This email address isn't valid.",
		sendCode: "Send the code",
		codeStepTitle: "Enter your code",
		codeStepHelp: "We sent an 8-digit code to {{email}}. Enter it here to sign in.",
		codePlaceholder: "12345678",
		verifyCode: "Verify",
		codeErrorInvalid: "Invalid code. Check the digits and try again.",
		codeErrorExpired: "This code has expired. Request a new one.",
		codeErrorGeneric: "Couldn't verify the code. Try again.",

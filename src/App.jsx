...
import { checkStorage, isStorageAvailable, loadData, saveData, getInitialData } from "@/utils/storage";
...
export default function FilmVaultApp() {
  ...
  return (
    <div className="min-h-screen bg-bg text-text-primary font-body max-w-[480px] mx-auto relative">
      ...
      {/* Mode indicator */}
      <div className={`fixed top-1.5 right-2 z-[200] text-[9px] font-mono opacity-60 flex items-center gap-1 ${persistent ? "text-green" : "text-amber"}`}>

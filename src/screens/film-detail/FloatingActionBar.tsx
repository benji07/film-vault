...
export function FloatingActionBar({ film, setShowAction }: FloatingActionBarProps) {
	...
	return (
		<div className="fixed bottom-0 left-0 right-0 md:left-[220px] p-4 pb-[max(1rem,env(safe-area-inset-bottom))] bg-gradient-to-t from-paper via-paper to-transparent z-10">
			<div className="max-w-3xl mx-auto">
				...
				{film.state === "loaded" && (
					<div className="flex gap-2">
						<Button onClick={() => setShowAction("finish")} className="flex-1 justify-center">

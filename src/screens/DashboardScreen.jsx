import { Snowflake, Camera, Eye, Archive, Clock, AlertTriangle, Film, Plus } from "lucide-react";
...
export function DashboardScreen({ data, setScreen, setSelectedFilm }) {
    ...
    <div className="flex flex-col gap-5">
      ...
      {expiring.length > 0 && (
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-[13px] font-bold font-body" style={{ color: T.amber }}>Péremption proche</span>
          </div>
      ...
      {films.length === 0 && (
        <EmptyState
          ...
          action={<Button onClick={() => setScreen("addFilm")}><Plus size={14} /> Ajouter une pellicule</Button>}
        />
      )}
    </div>
  );
